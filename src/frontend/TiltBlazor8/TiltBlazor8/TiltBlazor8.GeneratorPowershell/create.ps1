...
$pathToModels = "../TiltBlazor8.crats/src/Admin/Generated/Models/"+$nameContext
$pathToContext= "../TiltBlazor8.crats/src/Admin/Generated/DB/"+$nameContext
...
function Generate{
 ...
 Generate "Models"  "../TiltBlazor8.Models/Generated/" $project

 Generate "Context"  "../TiltBlazor8.Context/Generated/" $project

 Generate "Controllers"  "../TiltBlazor8.Controllers/Generated/" $project 

# Generate "crats"  "../TiltBlazor8.crats/src/Admin/Generated/" $project

# Generate "angular"  "../ExampleAngular/src/app/Admin/Generated/" $project
    
Generate "blazorList"  "../TiltBlazor8.Blazor/Pages/Generated/" $project 

Generate "blazorRow"  "../TiltBlazor8.Blazor/Pages/Generated/" $project 

#blazor do not admit lowercase razor files
$TextInfo = (Get-Culture).TextInfo
get-childitem -Recurse ../TiltBlazor8.Blazor/Pages/Generated/ -Filter *.razor | foreach { $NewName = $TextInfo.ToTitleCase($_); ren $_.FullName $NewName }
return
