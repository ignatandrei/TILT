...
$pathToModels = "../Net8TILT.crats/src/Admin/Generated/Models/"+$nameContext
$pathToContext= "../Net8TILT.crats/src/Admin/Generated/DB/"+$nameContext
...
Generate "blazorList"  "../Net8TILT.Blazor/Pages/Generated/" $project 

Generate "blazorRow"  "../Net8TILT.Blazor/Pages/Generated/" $project 

#blazor do not admit lowercase razor files
$TextInfo = (Get-Culture).TextInfo
get-childitem -Recurse ../Net8TILT.Blazor/Pages/Generated/ -Filter *.razor | foreach { $NewName = $TextInfo.ToTitleCase($_); ren $_.FullName $NewName }
return
